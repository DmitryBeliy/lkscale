-- ============================================
-- SETUP: Подготовка базы (выполнить один раз)
-- ============================================

-- Создание таблиц сразу с правильной структурой
...
-- Отключение FK для быстрой загрузки
...
-- Политики (с удалением существующих)
DO $$
BEGIN
